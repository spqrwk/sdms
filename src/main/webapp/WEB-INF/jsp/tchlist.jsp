...
<head>
    ...
    <!-- Page JS Plugins CSS -->
    <link rel="stylesheet" href="${realPath}/statics/assets/js/plugins/datatables/dataTables.bootstrap4.css">
                    ...
                    <ul class="nav-users push">
                        <li>
                            <a href="be_pages_generic_profile.html">
                                <img class="img-avatar" src="${realPath}/statics/assets/media/avatars/avatar8.jpg" alt="">
                        ...
                        <li>
                            <a href="be_pages_generic_profile.html">
                                <img class="img-avatar" src="${realPath}/statics/assets/media/avatars/avatar13.jpg" alt="">
                ...
                <ul class="nav-main">
                    ...
                    <li class="open">
                        ...
                        <ul>
                            ...
                            <li>
                                <a class="active" href="be_tables_datatables.html">DataTables</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                ...
                <div class="block-header block-header-default">
                    <div class="block-content block-content-full">
                        <form class="form-inline" action="${realPath}/tch/list" method="post">
                            ...
                            <input type="text" class="form-control mb-2 mr-sm-2 mb-sm-0" id="example-if-email" name="tchName" placeholder="请输入班主任姓名...">
...
<!-- Page JS Plugins -->
<script src="${realPath}/statics/assets/js/plugins/datatables/jquery.dataTables.min.js"></script>
<script src="${realPath}/statics/assets/js/plugins/datatables/dataTables.bootstrap4.min.js"></script>

<!-- Page JS Code -->
<script src="${realPath}/statics/assets/js/pages/be_tables_datatables.min.js"></script>
