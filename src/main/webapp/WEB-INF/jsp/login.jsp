...
<div id="page-container" class="main-content-boxed">
    ...
    <main id="main-container">
        ...
        <!-- Page Content -->
        <div class="bg-image" style="background-image: url('${realPath}/statics/assets/media/photos/photo34@2x.jpg');">
            <div class="row mx-0 bg-black-op">
                ...
                <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible" data-toggle="appear" data-class="animated fadeInRight">
                    <div class="content content-full">
                        ...
                        ${loginError}
                        <form class="js-validation-signin px-30" action="${realPath}/dologin" method="post">
...
<%--                            </div>--%>
                            <div class="form-group">
                                <button type="submit" class="btn btn-sm btn-hero btn-alt-primary">
                                    <i class="si si-login mr-10"></i> 登录
                                </button>
<%--                                <div class="mt-30">--%>
...
<!-- Page JS Plugins -->
<script src="${realPath}/statics/assets/js/plugins/jquery-validation/jquery.validate.min.js"></script>

<!-- Page JS Code -->
<script src="${realPath}/statics/assets/js/pages/op_auth_signin.min.js"></script>
